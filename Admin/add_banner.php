				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						...
						<div class="pull-right">
							<a href="add_banner.php" class="btn btn-primary btn-sm scroll-click" rel="content-y"  data-toggle="collapse" role="button"><i class="fa fa-code"></i> Source Code</a>
						</div>
					</div>
					<form action="check_addbanner.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label>Banner Caption</label>
							<input class="form-control" type="text" placeholder="Enter Banner Caption" name="banner_caption">
						</div>
                        <div class="form-group">
							<label>Banner SubCaption</label>
							<input class="form-control" type="text" placeholder="Enter Banner SubCaption" name="banner_sub_caption">
						</div>
						<div class="form-group">
							<label>Banner Index</label>
							<input class="form-control" type="number" placeholder="Enter Banner Index" name="banner_index">
						</div>
						<div class="form-group">
							<label>Convert</label>
						...
						<div class="form-group">
							...
							<input class="form-control" type="file" hidden="true" onchange="uploadimg(event)" id="file" name="banner_image"><br>
