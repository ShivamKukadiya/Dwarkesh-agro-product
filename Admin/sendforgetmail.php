...
if (isset($_POST['sendmail'])) {
    ...
    $query = "select * from log_in where username='$email'";
    ...
    if ($count > 0) {
        ...
        header('Location:forgot-password.php?message=User not exist');
    }
} else {
    header('Location:forgot-password.php?message=wrong button pressed');
}