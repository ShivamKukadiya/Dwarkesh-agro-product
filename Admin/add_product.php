		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form action="check_addproduct.php" method="post" enctype="multipart/form-data">
					<div class="form-group">
							<label>Category Name</label>
							<select class="form-control" onchange="getsubcategory(this.value)" type="text" id="" name="category_id">
							<option value="Y" selected>Select</option>
								<?php foreach($fetch as $cat){
						...
						<div class="form-group">
							...
							<select class="form-control" type="text" id="subcategory_list" name="subcategory_id">
						...
						<div class="form-group">
							...
							<input class="form-control" type="number" placeholder="Enter Product Price" name="price">
						</div>
						<div class="form-group">
							<label>Special Price</label>
							<input class="form-control" type="number" placeholder="Enter Product Special Price" name="special_price">
						</div>
                        <div class="form-group">
							<label>Product Quantity</label>
							<input class="form-control" type="number" placeholder="Enter Product Quantity" name="qty">
						</div>
                        <div class="form-group">
							<label>Product Description</label>
							<input class="form-control" type="text" placeholder="Enter Product Description" name="product_description">
						</div>
						<div class="form-group">
							<label>Product Image</label>
							<input class="form-control" type="file" hidden="true" onchange="uploadimg(event)" id="file" name="product_image"><br>
							<label for="file" class="btn btn-primary">Upload</label>
							<img src="" alt="" id="img_upload" height="100px" width="100px">
						</div>
						<div class="form-group">
							<label>Convert</label>
