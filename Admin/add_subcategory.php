		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">ADD SUBCATEGORIES</h4>
						</div>
						<div class="pull-right">
							<a href="add_subcategory.php" class="btn btn-primary btn-sm scroll-click" rel="content-y"  data-toggle="collapse" role="button"><i class="fa fa-code"></i> Source Code</a>
						</div>
					</div>
					<form action="check_addsubcategory.php" method="post" enctype="multipart/form-data">
					<div class="form-group">
						...
						<div class="form-group">
							...
							<input class="form-control" type="text" placeholder="Enter Subcategory Name" name="subcategory_name">
						</div>
						<div class="form-group">
							<label>SubCategory Description</label>
							<input class="form-control" type="text" placeholder="Enter Subcategory Description" name="subcategory_des">
						</div>
						
						<div class="form-actions center">
							<button type="submit" class="btn btn-primary" name="submitsubcategory">SUBMIT</button>
						</div>
