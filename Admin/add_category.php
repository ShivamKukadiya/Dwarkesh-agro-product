				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						...
						<div class="pull-right">
							<a href="add_category.php" class="btn btn-primary btn-sm scroll-click" rel="content-y"  data-toggle="collapse" role="button"><i class="fa fa-code"></i> Source Code</a>
						</div>
					</div>
					<form action="check_addcategory.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label>Category Name</label>
							<input class="form-control" type="text" placeholder="Enter Category Name" name="category_name">
						</div>
						<div class="form-group">
							<label>Category Description</label>
							<input class="form-control" type="text" placeholder="Enter Category Description" name="category_des">
						</div>
						<div class="form-group">
							<label>Convert</label>
						...
						<div class="form-group">
							...
							<input class="form-control" type="file" hidden="true" onchange="uploadimg(event)" id="file" name="category_image"><br>
