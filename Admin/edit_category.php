				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						...
						<div class="pull-right">
							<a href="add_category.php" class="btn btn-primary btn-sm scroll-click" rel="content-y"
								data-toggle="collapse" role="button"><i class="fa fa-code"></i> Source Code</a>
						</div>
					</div>
					<form action="check_editcategory.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label>Category Name</label>
							<input class="form-control" value="<?php echo $fetch['category_name']?>" type="text" placeholder="category Name" name="category_name">
						</div>
						<div class="form-group">
							<label>Category Description</label>
							<input class="form-control" value="<?php echo $fetch['category_des']?>" type="text" placeholder="category description" name="category_des">
						...
						<div class="form-group">
							...
							<input class="form-control" value=<?php echo $fetch['category_image']?> type="file" hidden="true" onchange="uploadimg(event)" id="file"
								name="category_image"><br>
							<label for="file" class="btn btn-primary">Upload</label>
							<?php
								if(isset($fetch['category_image']))
								{
										echo '<img src="categoriesimg/convert/TH'.$fetch['category_image'].'" alt="" id="img_upload" height="100px" width="100px">';
								}
							?>
