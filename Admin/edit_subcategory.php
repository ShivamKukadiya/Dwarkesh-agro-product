...
<body>
	...
	<?php
		...
		if(isset($_GET['subcat_id'])){
			...
			$query="select c.category_id,category_name,s.* from category c inner join subcategory s on c.category_id=s.category_id where s.subcategory_id='$subcat_id'";
		  $fetch2=$obj->fetchresult($query);
		  }
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">EDIT SUBCATEGORIES</h4>
						</div>
					...
					<form action="check_editsubcategory.php" method="post" enctype="multipart/form-data">
						<div class="form-body">
                ...
                ?>
							<div class="form-group">
								<label for="" class="form-group">Sub-Category Name</label>
								<input type="text" class="form-control" placeholder="sub-category Name"
									value="<?php echo $fetch2['subcategory_name']?>" name="subcategory_name">
							</div>
							<input type="hidden" name="subcategory_id" value="<?php echo $fetch2['subcategory_id']?>">
							<div class="form-group">
								<!-- <label for="donationinput2" class="sr-only">Category Discription</label> -->
								<label for="" class="form-group">Sub-Category Description</label>
								<input type="text" class="form-control" value="<?php echo $fetch2['subcategory_des']?>"
									placeholder="sub-category description" name="subcategory_des">
							</div>
